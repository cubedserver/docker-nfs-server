...
`docker run -d --name nfs --privileged -v /some/where/fileshare:/nfsshare -e SHARED_DIRECTORY=/nfsshare docker.pkg.github.com/cubedserver/docker-nfs-server/nfs-server:latest`
...
```
docker run -d --name nfs --privileged -v /some/where/fileshare:/nfsshare -v /some/where/else:/nfsshare/another -e SHARED_DIRECTORY=/nfsshare -e SHARED_DIRECTORY_2=/nfsshare/another docker.pkg.github.com/cubedserver/docker-nfs-server/nfs-server:latest
```
